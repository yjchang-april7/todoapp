import 'package:todoapp/models/user_entity.dart';
...
class User extends Equatable {
  ...
  User copyWith({required String email, String? name, String? phone}) {
    return User(email, name: name ?? this.name, phone: phone ?? this.phone);
  }
